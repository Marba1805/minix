...
#define NO_STACK	0
#define SMALL_STACK	(1024 * sizeof(char *))	/* orig 128 */
...
#define	TOT_STACK_SPACE	(IDL_S + HRD_S + (3 * TSK_S))
...
/* process nr,   pc, flags, qs,  queue, stack, traps, ipcto, call,  name */
	...
	{CTRLIF, ctrl_if_task,
	 TSK_F, 0, TASK_Q, TSK_S, SRV_T, SYS_M, 0, "CTRLIF"},
...
#endif
	{IS_PROC_NR, 0, SRV_F, 8, USER_Q, 0, SRV_T, SRV_M, IS_C, "is"}
};
